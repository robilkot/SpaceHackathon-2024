...
namespace SpaceHackathon_2024.Services
{
    public class ApplicationContext : DbContext
    {
        ...
        public async Task InitializeTestDataAsync()
        {
            ...
            await AddUserAsync(new User { Name = "Nikita", Surname = "Kalabin", AvatarURL = "https://distribution.faceit-cdn.net/images/f9b1e39c-bab2-49e6-8018-7ca56c33986b.jpeg", BranchOffice = "Департамент Пиццы", Department = "Гикало 9, Минск", Position = "Программист", FullName = "Никита Калабин" });
            await AddUserAsync(new User { Name = "Nikita", Surname = "Kharashun", AvatarURL = "https://fikiwiki.com/uploads/posts/2022-02/1645019125_27-fikiwiki-com-p-kartinki-dlya-stima-na-avu-28.jpg", BranchOffice = "На галере", Department = "Гикало 9, Минск", Position = "Программист", FullName = "Никита Хорошун" });
            ...
            await AddUserAsync(new User { Name = "Timur", Surname = "Robilko", AvatarURL = "https://ru-static.z-dn.net/files/d3b/3cc3216ecef61bd569d2250340f708a0.png", BranchOffice = "Дома :)", Department = "Гикало 9, Минск", Position = "Программист", FullName = "Тимур Робилко" });
